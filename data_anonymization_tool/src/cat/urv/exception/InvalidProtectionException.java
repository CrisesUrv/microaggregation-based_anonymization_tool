 ...
 */
public class InvalidProtectionException extends Exception {
	/**
	 * 
	 */
	...
	public InvalidProtectionException()
	{
		super();
	}
	
	public InvalidProtectionException(String parameter)
	{
	 ...
	 */
	public InvalidProtectionException(String message, String parameter)
	{
